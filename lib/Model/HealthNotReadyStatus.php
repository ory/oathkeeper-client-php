 ...
 */
class HealthNotReadyStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets errors
     *
     * @param array<string,string>|null $errors Errors contains a list of errors that caused the not ready status.
     *
     * @return self
     */
