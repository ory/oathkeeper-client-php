...
_Please note_: We take Ory Ory Oathkeeper PHP Client's security and our users' trust very
seriously. If you believe you have found a security issue in Ory Ory Oathkeeper PHP Client,
...
do this is via
[Ory Ory Oathkeeper PHP Client Discussions](https://github.com/orgs/ory/discussions)
...
- I have a question. Where can I get
  [answers to questions regarding Ory Ory Oathkeeper PHP Client?](#communication)
...
- I want to talk to other Ory Ory Oathkeeper PHP Client users.
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory Ory Oathkeeper PHP Client.
...
- **Helping with open issues.** We have a lot of open issues for Ory Ory Oathkeeper PHP Client
...
Check out [Ory Ory Oathkeeper PHP Client Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory Ory Oathkeeper PHP Client,
...
before getting started to ensure your work is consistent with Ory Ory Oathkeeper PHP Client's
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform
   ...
   [list of prefixes for Ory Oathkeeper PHP Client](https://github.com/ory/oathkeeper-client-php/blob/master/.github/semantic.yml)
   for an overview.
...
[docs](https://github.com/ory/oathkeeper-client-php/tree/master/docs) folder. Generate API and
configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/oathkeeper-client-php/blob/master/README.md).
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the Ory Ory Oathkeeper PHP Client
