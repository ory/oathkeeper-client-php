...
Ory Oathkeeper PHP Client's direction. A great way to
do this is via
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/oathkeeper-client-php/blob/master/.github/workflows/conventional_commits.yml)
