...
# Contribute to Ory Ory Oathkeeper PHP Client<!-- omit in toc -->
...
[open a well-written issue or discussion](https://github.com/ory/oathkeeper-client-php/issues):
...
- **Help with open issues.** We have a lot of open issues for Ory Ory Oathkeeper PHP Client and
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/ory/oathkeeper-client-php/blob/master/.github/workflows/conventional_commits.yml)
...
maintain the quality and reliability of Ory Ory Oathkeeper PHP Client, please follow these
guidelines:
...
git clone git@github.com:ory/oathkeeper-client-php.git
